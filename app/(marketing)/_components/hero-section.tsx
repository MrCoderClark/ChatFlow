...
import HeroLight from '@/public/screenshot-lite.png';
          ...
          <div className="relative pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                >
                  ChatFlow organizes conversations into channels with threads,
                  is real-time and uses AI to keep teams in sync.
                </TextEffect>
